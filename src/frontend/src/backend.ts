...
import type { Order as _Order, Rank as _Rank, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createRank(arg0: Rank): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createRank(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteRank(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteRank(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getActiveRanks(): Promise<Array<Rank>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActiveRanks();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRank(arg0: string): Promise<Rank | null> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async updateRank(arg0: Rank): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRank(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Rank]): Rank | null {
    return value.length === 0 ? null : value[0];
}
